...
<template data-theme="light">
  ...
  <AppLayout title="Crowdfunding" data-theme="light">
    <template #header >
      ...
      <div class="flex bg-gradient-to-br from-indigo-50 to-indigo-100 justify-center px-60 py-10 ">
            <div class="h-screen">
                  <div class=" rounded border border-none relative flex items-center bg-white px-4 pt-14 pb-8 overflow-hidden shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8">
                      ...
                      <div class=" grid grid-cols-1 gap-y-8 gap-x-6 items-start sm:grid-cols-12 lg:gap-x-8">
                        <div class="aspect-w-2 aspect-h-3 rounded-lg bg-gray-100 overflow-hidden sm:col-span-4 lg:col-span-5">
                          <img src="https://images.unsplash.com/photo-1523132797263-747d5d0dbbb3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80" alt="image projet" />
                        </div>
                        <div class="sm:col-span-8 lg:col-span-7">
                          ...
                          <section aria-labelledby="information-heading" class="mt-2">
                            <h3 id="" class="sr-only">Details du projet</h3>
                            ...
                            <form>
                              ...
                              <div class="mt-10">
                                <div class="flex items-center justify-between">
                                  <h4 class="text-sm text-gray-900 font-medium">Description du projet</h4>
                                </div>
                              ...
                              <div class="mt-10">
                                <div class="flex items-center justify-between">
                                  <h4 class="text-sm text-gray-900 font-medium">Cagnotte du projet</h4>
                                </div>
                                  <p class="text-lg text-black font-semibold">
                                  Cagnotte<br>
                              ...
                              <a :href=" projet.id + '/addFinance/' " class="mt-6 font-extrabold  w-full bg-indigo-500 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Financer ce projet !
                                </a>
                            </form>
                          </section>
        ...
        <div class="bg-gradient-to-br from-indigo-100 to-yellow-100">
          <div class="py-16  border border-none mb-24">  
            <div class="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
                <div class="mb-12 space-y-2 text-center">
                  <span class="block w-max mx-auto px-3 py-1.5 border border-indigo-200 rounded-full bg-yellow-100 text-indigo-700">Blog</span>
                  <h2 class="text-2xl text-indigo-600 font-bold md:text-4xl">Partager = Prendre Soin..</h2>
                ...
                <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                  <div class="relative p-1 pb-16 rounded-xl group bg-white bg-opacity-50 shadow-xl hover:rounded-2xl">
                    <div class="relative">
                      ...
                      <img src="https://images.unsplash.com/photo-1563452965085-2e77e5bf2607?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80" alt="art cover" loading="lazy" width="1000" height="667" class="h-64 w-full object-cover object-top rounded-t-lg transition duration-500 group-hover:rounded-t-xl">
                    </div>
                    <div class="relative space-y-4 -mt-20 p-4">
                      <h4 class="text-2xl font-semibold text-indigo-900">Mamadou Diallo</h4>
                    ...
                    <a href="#" class="absolute inset-x-4 bottom-4 flex items-center space-x-2">
                      <div aria-hidden="true" class="h-10 w-10 flex border border-warning rounded-full">
                        <svg aria-hidden="true" width="24" height="24" fill="none" class="my-auto mx-auto flex-none text-indigo-700">
                      ...
                      <span class="text-indigo-600">Read more</span>
                    </a>
                  </div>
                  <div class="relative p-1 pb-16 rounded-xl group bg-white bg-opacity-50 shadow-xl hover:rounded-2xl">
                    <div class="relative">
                      <div aria-hidden="true" class="absolute inset-x-0 bottom-0 h-64 bg-gradient-to-b from-transparent to-yellow-50"></div>
                      <img src="https://images.unsplash.com/photo-1523824921871-d6f1a15151f1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80" alt="art cover" loading="lazy" width="1000" height="667" class="h-64 w-full object-cover object-top rounded-t-lg transition duration-500 group-hover:rounded-t-xl">
                    </div>
                    <div class="relative space-y-4 -mt-20 p-4">
                      <h4 class="text-2xl font-semibold text-indigo-900">Naffissatou Ndoye</h4>
                      <p class="text-gray-600">" Voluptates harum aliquam totam, doloribus eum impedit atque! Temporibus...</p>
                    </div>
                    <a href="#" class="absolute inset-x-4 bottom-4 flex items-center space-x-2">
                      <div aria-hidden="true" class="h-10 w-10 flex border border-warning rounded-full">
                  ...
                  <div class="relative p-1 pb-16 rounded-xl group bg-white bg-opacity-50 shadow-xl hover:rounded-2xl">
                    <div class="relative">
                      <div aria-hidden="true" class="absolute inset-x-0 bottom-0 h-64 bg-gradient-to-b from-transparent to-yellow-50"></div>
                      <img src="https://images.unsplash.com/photo-1614890085618-0e1054da74f8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80" alt="art cover" loading="lazy" width="1000" height="667" class="h-64 w-full object-cover object-top rounded-t-lg transition duration-500 group-hover:rounded-t-xl">
                    </div>
                    <div class="relative space-y-4 -mt-20 p-4">
                      <h4 class="text-2xl font-semibold text-indigo-900">Cheikh Tidiane Diop</h4>
                      <p class="text-gray-600">" Voluptates harum aliquam totam, doloribus eum impedit atque! Temporibus...</p>
                    </div>
                    <a href="#" class="absolute inset-x-4 bottom-4 flex items-center space-x-2">
                      <div aria-hidden="true" class="h-10 w-10 flex border border-warning rounded-full">
                  ...
                  <div class="relative p-1 pb-16 rounded-xl group bg-white bg-opacity-50 shadow-xl hover:rounded-2xl">
                    <div class="relative">
                      <div aria-hidden="true" class="absolute inset-x-0 bottom-0 h-64 bg-gradient-to-b from-transparent to-yellow-50"></div>
                      <img src="https://images.unsplash.com/photo-1520943219761-6ca840e2e585?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=388&q=80" alt="art cover" loading="lazy" width="1000" height="667" class="h-64 w-full object-cover rounded-t-lg transition duration-500 group-hover:rounded-t-xl">
                    </div>
                    <div class="relative space-y-4 -mt-20 p-4">
                      <h4 class="text-2xl font-semibold text-indigo-900">Awa Sène</h4>
                      <p class="text-gray-600"> " Voluptates harum aliquam totam, doloribus eum impedit atque! Temporibus...</p>
                    </div>
                    <a href="#" class="absolute inset-x-4 bottom-4 flex items-center space-x-2">
                      <div aria-hidden="true" class="h-10 w-10 flex border border-warning rounded-full">
          ...
          <section class="container mx-auto overflow-hidden bg-white rounded-xl shadow-lg bg-primary border border-none mb-12 ">
            <div class="container px-6 py-10 mx-auto">
                <div class="lg:flex lg:items-center">
                    <div class="w-full space-y-12 lg:w-1/2 ">
                        <div>
                            <h1 class="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">Participez à <br>{{projet.nom}}</h1>
                        
                            <div class="mt-2">
                                <span class="inline-block w-40 h-1 rounded-full bg-warning"></span>
                                <span class="inline-block w-3 h-1 ml-1 rounded-full bg-warning"></span>
                                <span class="inline-block w-1 h-1 ml-1 rounded-full bg-warning"></span>
                            </div>
                        </div>
                        ...
                        <div class="md:flex md:items-start md:-mx-4">
                            ...
                            <div class="mt-4 md:mx-4 md:mt-0">
                                <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">La simplicité du partage</h1>

                                <p class="mt-3 text-gray-500 dark:text-gray-300">
                                Les intérêts des investisseurs et de l’entrepreneur sont alignés. Puis Un investissement sans les contraintes du statut d’actionnaire. </p>
                            </div>
                        </div>
                        ...
                        <div class="md:flex md:items-start md:-mx-4">
                            ...
                            <div class="mt-4 md:mx-4 md:mt-0">
                                <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Soyez acteur d'une révolution</h1>

                                <p class="mt-3 text-gray-500 dark:text-gray-300">
                                Contribuez au développement local, soutenez des secteurs d’activité qui vous parlent et diversifiez votre démarche en investissant dans des projets à impacts.                                </p>
                            </div>
                        </div>
                        ...
                        <div class="md:flex md:items-start md:-mx-4">
                            ...
                            <div class="mt-4 md:mx-4 md:mt-0">
                                <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Ensemble on va plus loin</h1>

                                <p class="mt-3 text-gray-500 dark:text-gray-300">
                                    Quels que soient nos goûts ou les causes que l’on défend, nous croyons que les partager ensemble est essentiel.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="hidden lg:flex lg:items-center lg:w-1/2 lg:justify-center">
                        <img class="w-[28rem] h-[28rem] object-cover xl:w-[34rem] xl:h-[34rem] rounded-full" src="https://images.unsplash.com/photo-1523132797263-747d5d0dbbb3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80" alt="">
                    </div>
                </div>
